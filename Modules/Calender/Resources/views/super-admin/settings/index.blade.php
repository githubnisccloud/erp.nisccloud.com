            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 text-end">
                    <div class="form-check form-switch custom-switch-v1 float-end">
                        <input type="checkbox" name="google_calendar_enable" class="form-check-input input-primary" id="google_calendar_enable"{{ (isset($admin_setting['google_calendar_enable']) ? $admin_setting['google_calendar_enable'] : 'off') == 'on' ? ' checked ' : '' }} >
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control is_google_calender_on" value="{{ isset($admin_setting['google_calender_id']) ? $admin_setting['google_calender_id'] : '' }}" name="google_calender_id" placeholder="Google Calendar Id" {{ (isset($admin_setting['google_calendar_enable']) ? $admin_setting['google_calendar_enable'] : 'off')  == 'on' ? '' : ' disabled' }}>
                    </div>

                    <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                        {{Form::label('Google calendar json file',__('Google Calendar json File'),['class'=>'col-form-label']) }}
                        <input type="file" class="form-control is_google_calender_on" accept=".json" name="google_calender_json_file" id="file" {{ (isset($admin_setting['google_calendar_enable']) ? $admin_setting['google_calendar_enable'] : 'off')  == 'on' ? '' : ' disabled' }}>
                    </div>
                </div>
            </div>
