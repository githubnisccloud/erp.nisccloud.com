...
@php
    $path = url("/Modules/Calender/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Calender Helps You Simplify Your Work')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            ...
                            <div class="set has-children">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('Get a calendar view for every lead detail. In short, managing lead has never been easier with the calender of lead visibility in the system.')}}</p>
                                </div>
                            </div>
