...
class SentRetainerLis
{
     ...
     * @return void
     */
    public function handle(SentRetainer $event)
    {
        if (module_is_active('ActivityLog')) {
            ...
            $activity['sub_module']     = '--';
            $activity['description']    = __('Retainer ') . Retainer::retainerNumberFormat($retainer->retainer_id) . __(' Send to ') . $user->name . __(' by the ');
