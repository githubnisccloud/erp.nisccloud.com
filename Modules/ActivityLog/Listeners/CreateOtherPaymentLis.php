...
class CreateOtherPaymentLis
{
     ...
     * @return void
     */
    public function handle(CreateOtherPayment $event)
    {
        if (module_is_active('ActivityLog')) {
            ...
            $activity['description']    = __('New Other Payment created of employee ') . Employee::employeeIdFormat($otherpayment->employee_id) . __(' by the ');
