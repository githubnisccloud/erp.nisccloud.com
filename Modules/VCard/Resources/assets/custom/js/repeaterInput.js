                    ...
                    <div class="input-edits inputFormRow mb-4">
                        ...
                        if(element == "Address"){
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="${element}_${rowno}" name="contact[${rowno}][${element}][${element}]" class=" form-control contact_href" placeholder="Enter Address" required/>
                                <div class="input-group">
                        ...
                        else
                        {
                            ...
                            <span class="input-group-text"><img  src="${assets}/${element.toLowerCase()}.svg" ></span>
                            <input type="text" id="${element}_${rowno}" name="contact[${rowno}][${element}]" class=" form-control contact_href" required/>
                            </div>`;
                        }
            ...
            if(chatgpt==1)
            {
                html = `<div class="col-md-6" id="inputFormRow2">
                        <div class="services-setting-card" >
                                ...
                                <div class="text-end">
                                    <a  class="btn btn-primary text-white btn-sm" data-size="lg" data-ajax-popup-over="true" data-url="`+ai_url+`/aiassistant/generate_service/service business/VCard/`+rowno+`" data-bs-toggle="tooltip" data-bs-placement="top" title="Generate" data-title="Generate Content With AI">
        ...
        if (element_type == "testimonial") {
            ...
            if(chatgpt==1)
            {
                html = `<div class="col-md-6" id="inputFormRow3">
                                ...
                                <div class="text-end">
                                    <a  class="btn btn-primary text-white btn-sm" data-size="lg" data-ajax-popup-over="true" data-url="`+ai_url+`/aiassistant/generate_testimonial/testimonial/VCard/`+rowno+`" data-bs-toggle="tooltip" data-bs-placement="top" title="Generate" data-title="Generate Content With AI">
                                    <i class="fas fa-robot"></i> Generate with AI
                                </a> 
                                </div>
