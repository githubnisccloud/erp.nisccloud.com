...
@php
    $path =  url("/Modules/VCard/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Digital ')}}<b>{{__(' Business Card ')}}</b> {{__(' Builder')}}</h2>
                  
                <p>{{__('vCard create a digital business card that helps you reach more customers')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Stop wasting money on Expensive Hard Copy Business Cards')}}</h2>
                        </div>
                        <p>{{__('A vCard is an electronic business or personal card and also the name of an industry specification for the kind of communication exchange that is done on business or personal cards. You may have seen a vCard attached to an email note someone has sent you.')}} </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Self-manageable and intuitive')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('vCard is fast, easy and intuitive! You only need a few steps to have your own virtual card. Manage your business` cards in seconds and modify any content with immediate application through an easy and intuitive platform.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Smarten your business cards.')}}</h2>
                        </div>
                        <p>{{__('Digital business cards also known as virtual business cards and e business cards are like the digital makeover that the paper cards have needed for a long time.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Choose what to share!')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Our vcards are self-manageable, therefore, you’ll always be in control of the information you’re sharing. Centralize all your social media profiles and make your community grow.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('The most cost-effective way to expand your reach')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Customize your digital business card to match your brand.Choose from 21 beautiful themes with it`s unique colors.Add,modify update your business information quickly and easily')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
