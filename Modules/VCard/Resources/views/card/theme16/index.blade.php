...
<head>
  ...
  <link rel="icon" href="{{ (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png') }}" type="image" sizes="16x16">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/fonts/stylesheet.css') }}">
    ...
    @if (isset($is_slug))
        ...
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme16/css/responsive.css') }}">
    @endif
...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme16'][$business->theme_color]['theme_name'] }}"
            id="view_theme5">
                                                ...
                                                <li class="socials_{{ $loop->parent->index + 1 }}"
                                                    ...
                                                    <div>
                                                        <a href="{{ $social_links }}"
                                                            ...
                                                            target="_blank">
                                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                    ...
                                                                    @if ($key1 == 'Address')
                                                                        ...
                                                                        <a href="{{ $href }}" target="_blank">
                                                                            <div class="contact-svg">
                                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                    class="img-fluid">
                        ...
                        @if ($order_key == 'more')
                            <section class="more-card-second-section">
                                <div class="container">
                                    <div class="more-card-btn">
                                        <a href="javascript:;" class="btn" tabindex="0"
                                            onclick="location.href = 'https://demo.rajodiya.com/vcardgo/download/robert-patricia'">
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/modal/bootstrap.min.js') }}"></script>

    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/js/slick.min.js') }}" defer="defer"></script>

    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme16/js/custom.js') }}" defer="defer"></script>
    @endif
