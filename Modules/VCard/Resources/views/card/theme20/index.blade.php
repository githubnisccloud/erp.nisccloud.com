...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/fonts/stylesheet.css') }}">
    ...
    @if (isset($is_slug))
        ...
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme20/css/responsive.css') }}">
    @endif
...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme20'][$business->theme_color]['theme_name'] }}" id=view_theme9>
                                                            ...
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                <div class="justify-content-start">
                                                                    <div class="contact-label">
                                                                        <span>
                                                                            @if($social_key1=='Web_url'){{'Web URL'}} @else{{ __($social_key1) }}@endif
                                                                        </span>
                                                                    </div>
                                                        ...
                                                        <li class="socials_{{ $loop->parent->index + 1 }}"
                                                            ...
                                                            <div>
                                                                <a href="{{ $social_links }}"
                                                                    ...
                                                                    target="_blank">
                                                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/icon/social/' . strtolower($social_key1) . '.svg') }}"
                                                                        alt="{{ $social_key1 }}"
                            ...
                            <ul class="card-social-icons">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/shareArticle?url={{urlencode($url_link)}}&title=">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path  d="M0 3C0 1.34315 1.34315 0 3 0H17C18.6569 0 20 1.34315 20 3V17C20 18.6569 18.6569 20 17 20H3C1.34315 20 0 18.6569 0 17V3Z" stroke="black" stroke-width="1.5"/>
                                            <path d="M5 6C5.55228 6 6 5.55228 6 5C6 4.44772 5.55228 4 5 4C4.44772 4 4 4.44772 4 5C4 5.55228 4.44772 6 5 6Z" fill="black"/>
                                            <path d="M5 8C4.44772 8 4 8.44772 4 9V15C4 15.5523 4.44772 16 5 16C5.55228 16 6 15.5523 6 15V9C6 8.44772 5.55228 8 5 8Z" fill="black"/>
                                            <path d="M12 10C10.8954 10 10 10.8954 10 12V15C10 15.5523 9.55229 16 9 16C8.44771 16 8 15.5523 8 15V9C8 8.44772 8.44772 8 9 8C9.40537 8 9.7544 8.2412 9.91141 8.58791C10.5193 8.215 11.2346 8 12 8C14.2091 8 16 9.79086 16 12V15C16 15.5523 15.5523 16 15 16C14.4477 16 14 15.5523 14 15V12C14 10.8954 13.1046 10 12 10Z" fill="black"/>
                                            </svg>
                                    </a>
                                </li>
                                <li>
                                    <a href="" id="copylink" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="" class="copy-icon insta-icon">
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/modal/bootstrap.min.js') }}"></script>

    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/js/slick.min.js') }}" defer="defer"></script>

    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme20/js/custom.js') }}" defer="defer"></script>
    @endif
