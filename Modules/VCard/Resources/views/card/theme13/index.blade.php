...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/fonts/stylesheet.css') }}">
    ...
    @if (isset($is_slug))
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/css/rtl-main-style.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/css/main-style.css') }}">
    @endif
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme13/css/responsive.css') }}">
...
<body class="tech-card-body">
    ...
    <div id="boxes">
        <div id="view_css"
            class="{{ \Modules\VCard\Entities\Business::themeOne()['theme13'][$business->theme_color]['theme_name'] }}">
                                                    ...
                                                    <div class="calllink contactlink "
                                                        ...
                                                        @if ($key1 == 'Address')
                                                            ...
                                                            <a href="{{ $href }}" target="_blank">
                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                        ...
                        @if ($order_key == 'gallery')
                            <section class="gallery-section common-border padding-top" id="gallery-div">
                                <div class="container">
                                    <div class="section-title">
                                        <div class="title-svg">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/icon/' . $color . '/gallery.svg') }}"
                                                                        ...
                                                                        @elseif($gallery_content->type == 'custom_video_link')
                                                                            @if (str_contains($gallery_content->value, 'youtube') || str_contains($gallery_content->value, 'youtu.be'))
                                                                                ...
                                                                                <a href="javascript:;" id=""
                                                                                    ...
                                                                                    <video loop autoplay
                                                                                        controls="true"
                                                                                        poster="{{ asset('Modules/VCard/Resources/assets/custom/img/video-poster.jpg') }}">
                                                    ...
                                                    @if ($social_key1 != 'id')
                                                        <li class="socials_{{ $loop->parent->index + 1 }} social-image-icon"
                                                            ...
                                                            <a href="{{ $social_links }}"
                                                                ...
                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                    alt="{{ $social_key1 }}"
                                                                    class="img-fluid hover-hide">
                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/icon/' . $color . '/social_white/' . strtolower($social_key1) . '.svg') }}"
                                                                    alt="{{ $social_key1 }}"
                    ...
                    <div class="share-card-wrapper">
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                ...
                                <li>
                                    <a href="" id="copylink" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" title="" class="copy-icon insta-icon">
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/modal/bootstrap.min.js') }}"></script>

    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme13/js/custom.js') }}" defer="defer"></script>
    @endif
