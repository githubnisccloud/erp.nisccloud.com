...
<head>
    ...
    <meta property="og:image"
        content="{{ !empty($business->meta_image) ? $meta_tag_image : asset('Modules/VCard/Resources/assets/custom/img/placeholder-image.jpg') }}">
    ...
    <link rel="icon"
        href="{{ isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png' }}"
        type="image" sizes="16x16">
    <link rel="stylesheet"
        href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/fonts/stylesheet.css') }}">
    @if (isset($is_slug))
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/css/rtl-main-style.css') }}">
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme12/css/responsive.css') }}">
    @endif
    ...
    @if (isset($is_slug))
        <link rel='stylesheet' href='{{ asset('Modules/VCard/Resources/assets/custom/css/cookieconsent.css') }}'
            media="screen" />
        <style type="text/css">
            {{ $business->customcss }}
        </style>
    ...
    <link rel="apple-touch-icon" href="{{ $company_favicon }}" />
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme12'][$business->theme_color]['theme_name'] }}"
            id="view_css">
            <!--wrapper start here-->
                    ...
                    @if ($j == $order_value)
                                                                    ...
                                                                    @if ($key1 == 'Address')
                                                                        ...
                                                                        <a href="{{ $href }}"
                                                                            ...
                                                                            <div class="contact-svg">
                                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                    class="img-fluid">
                                                                            </div>
                        ...
                        @if ($order_key == 'bussiness_hour')
                            <section class="business-hour-section padding-top padding-bottom" id="business-hours-div">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/clock.svg') }}"
                        ...
                        @if ($order_key == 'appointment')
                            <section class="appointment-section padding-top padding-bottom" id="appointment-div">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/calendar.svg') }}"
                        ...
                        @if ($order_key == 'service')
                            <section class="service-section padding-top padding-bottom" id="services-div">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/phone.svg') }}"
                        ...
                        <section class="product-section padding-top padding-bottom" id="product-div">
                            <div class="title-svg">
                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/product.svg') }}"
                                    alt="phone" class="img-fluid">
                            </div>
                            <div class="container">
                    ...
                    @endif
                        @if ($order_key == 'gallery')
                            <section class="gallery-section padding-top padding-bottom" id="gallery-div">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/gallery.svg') }}"
                                        alt="phone" class="img-fluid">
                                </div>
                                <div class="container">
                                    <div class="section-title text-center">
                                                                            ...
                                                                            <a href="javascript:;" id=""
                                                                                ...
                                                                                <video loop autoplay controls="true">
                                                                                    <source class="videoresource"
                                                                                        src="{{ isset($gallery_content->value) && !empty($gallery_content->value) ? get_file($gallery_content->value) : asset('Modules/VCard/Resources/assets/custom/img/logo-placeholder-image-2.png') }}"
                                                                                        type="video/mp4">
                                                                                </video>
                                                                            </a>
                        ...
                        @if ($order_key == 'more')
                            <section class="more-card-section padding-top padding-bottom">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/bookmark.svg') }}"
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        <a href="{{ route('bussiness.save', $business->slug) }}" class="btn"
                                            tabindex="0">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/folder.svg') }}"
                                                alt="folder" class="img-fluid">
                                            &nbsp;
                                            {{ __('Save Card') }}
                                        </a>
                                        <a href="javascript:;" class="btn our-card" tabindex="0">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/signout.svg') }}"
                        ...
                        @if ($order_key == 'social')
                            <section class="social-icons-section padding-top" id="social-div">
                                <div class="title-svg">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/share.svg') }}"
                                                    ...
                                                    @if ($social_key1 != 'id')
                                                        <li class="socials_{{ $loop->parent->index + 1 }} social-image-icon"
                                                            ...
                                                            <a href="{{ $social_links }}"
                                                                ...
                                                                target="_blank">
                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/' . strtolower($social_key1) . '.svg') }}"
                    ...
                    <form class="appointment-form-wrapper">
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/close.svg') }}"
                        ...
                        <div class="qr-scaner-wrapper">
                            ...
                            <ul class="card-social-icons">
                                <li><a href="https://twitter.com/share?url={{urlencode($url_link)}}&text=">
                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/twitter.svg') }}"
                                        alt="twitter" class="img-fluid" height="30px" width="30px"></a></li>
                                <li>@php
                                    $whatsapp_link = url('https://wa.me/?text=' . urlencode($url_link));
                                @endphp
                                        <a href="{{ $whatsapp_link }}">
                                        <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/whatsapp.svg') }}"
                                ...
                                <li><a href="https://www.facebook.com/sharer.php?u={{urlencode($url_link)}}"><img
                                            src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/facebook.svg') }}"
                                            ...
                                            <li><a href="https://www.linkedin.com/shareArticle?url={{urlencode($url_link)}}&title="><img
                                                src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/linkedin.svg') }}"
                                                alt="linkedin" class="img-fluid" height="30px" width="30px"></a>
                                    </li>
                                <li>
                                    <a href="" id="copylink" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="" class="copy-icon insta-icon">
                                        <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/icon/' . $color . '/copylink.svg') }}"
                                            alt="copylink" class="img-fluid" height="30px" width="30px">
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <img src="{{ isset($qr_detail->image) ? get_file($qr_detail->image) : '' }}"
    ...
    <!--scripts start here-->
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme12/js/custom.js') }}" defer="defer"></script>
    @endif
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/libs/bootstrap-notify/bootstrap-notify.min.js') }}">
    </script>
