...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/fonts/stylesheet.css') }}">
    ...
    @if (isset($is_slug))
        ...
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/modal/bootstrap.min.css') }}">
    @endif

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/css/rtl-main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme14/css/responsive.css') }}">
    @endif
...
<body  class="tech-card-body">
    <div id="boxes">
        <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme14'][$business->theme_color]['theme_name'] }}"
            id="view_theme3">
                                                                    ...
                                                                    @if ($key1 == 'Address')
                                                                        ...
                                                                        <a href="{{ $href }}">
                                                                            <div class="contact-svg">
                                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                    class="img-fluid">
                                                                            </div>
                                ...
                                <div class="container">
                                    ...
                                    <div class="more-btn">
                                        <a href="{{ route('bussiness.save', $business->slug) }}" class="btn"
                                            tabindex="0">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/' . $color . '/folder.svg') }}"
                                                alt="folder" class="img-fluid">
                                            &nbsp;
                                            {{ __('Save Card') }}
                                        </a>
                                        <a href="javascript:;" class="btn our-card" tabindex="0">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/' . $color . '/signout.svg') }}"
                                                alt="signout" class="img-fluid">
                                            &nbsp;
                                            {{ __('Share Card') }}
                                        </a>
                                        <a href="javascript:;" class="btn our-contact" tabindex="0">
                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/' . $color . '/phone.svg') }}"
                                                alt="signout" class="img-fluid">
                                            &nbsp;
                                            {{ __('Contact') }}
                                        </a>
                                                            ...
                                                            <li>
                                                                <div class="socials_{{ $loop->parent->index + 1 }}"
                                                                    ...
                                                                    <a href="{{ $social_links }}" 
                                                                        ...
                                                                        target="_blank">
                                                                        <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/social/' . strtolower($social_key1) . '.svg') }}"
                ...
                <div class="container">
                    <form class="appointment-form-wrapper contact-form-wrapper">
                        <div class="section-title">
                            ...
                            <div class="close-search">
                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/icon/' . $color . '/close.svg') }}" alt="back"
                                    class="img-fluid">
                            </div>
                        </div>
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/modal/bootstrap.min.js') }}"></script>

    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/js/slick.min.js') }}" defer="defer"></script>

    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme14/js/custom.js') }}" defer="defer"></script>
    @endif
