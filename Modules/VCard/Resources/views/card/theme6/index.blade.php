...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/fonts/stylesheet.css') }}">
    @if ($SITE_RTL == 'on')
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/css/rtl-main-style.css') }}">
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme6/css/responsive.css') }}">
    @endif
    @if (isset($is_slug))
...
<body class="tech-card-body">
    <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme6'][$business->theme_color]['theme_name'] }}"
        id="view_theme16">
        <main id="boxes">
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}">
                                                                        <span>
                                                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/icon/social/' . strtolower($social_key1) . '.svg') }}"
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme6/js/custom.js') }}" defer="defer"></script>
    @endif
