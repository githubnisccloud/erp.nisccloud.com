...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/fonts/stylesheet.css') }}">

    @if ($SITE_RTL == 'on')
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/css/rtl-main-style.css') }}">
        <link rel="stylesheet"
            href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/css/rtl-responsive.css') }}">
    @else
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/css/main-style.css') }}">
        <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme8/css/responsive.css') }}">
    @endif
    @if (isset($is_slug))
...
<body class="tech-card-body">
    <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme8'][$business->theme_color]['theme_name'] }}"
        id="view_theme18">
        <main id="boxes">
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/icon/social/' . strtolower($social_key1) . '.svg') }}"
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    <a href="{{ $href }}">
                                                                        <span>
                                                                            <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/icon/' . $color . '/' . strtolower($key1) . '.svg') }}"
                                                                                class="img-fluid">
                                                                        </span>
                                                                        @foreach ($val1 as $key2 => $val2)
                                                                            @if ($key2 == 'Address')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="social-list modal-share">
                            <li>
                                <a href="https://www.facebook.com/sharer.php?u={{urlencode($url_link)}}" class="fb-icon">
    ...
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/js/jquery.min.js') }}"></script>
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/js/slick.min.js') }}" defer="defer"></script>
    @if ($SITE_RTL == 'on')
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/js/rtl-custom.js') }}" defer="defer"></script>
    @else
        <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme8/js/custom.js') }}" defer="defer"></script>
    @endif
