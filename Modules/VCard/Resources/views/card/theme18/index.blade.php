...
<link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/libs/@fortawesome/fontawesome-free/css/all.min.css') }}">
<link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/fonts/stylesheet.css') }}">
...
@if (isset($is_slug))
    ...
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/modal/bootstrap.min.css') }}">
@endif

@if ($SITE_RTL == 'on')
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/css/rtl-main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/css/rtl-responsive.css') }}">
@else
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/css/main-style.css') }}">
    <link rel="stylesheet" href="{{ asset('Modules/VCard/Resources/assets/custom/theme18/css/responsive.css') }}">
@endif
...
<body class="tech-card-body">
    <div id="boxes">
        <div class="{{ Modules\VCard\Entities\Business::themeOne()['theme18'][$business->theme_color]['theme_name'] }}" id="view_theme7">
            <div class="home-wrapper" >
                <section class="home-banner-section">

                    <img src="{{ isset($business->banner) && !empty($business->banner) ? get_file($business->banner) : asset('Modules/VCard/Resources/assets/custom/img/placeholder-image.jpg') }}"
                                                                    ...
                                                                    @if ($key1 == 'Address')
                                                                        ...
                                                                        <a href="{{ $href }}" target="_blank">
                                                                            ...
                                                                            <div class="contact-svg">
                                                                                <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/icon/' . $color . '/contact/' . strtolower($key1) . '.svg') }}"
                                                                                    class="img-fluid">
                                                                            </div>
                                                            ...
                                                            <li class="socials_{{ $loop->parent->index + 1 }}"
                                                                ...
                                                                <div >
                                                                    <a href="{{ $social_links }}"
                                                                        ...
                                                                        target="_blank">
                                                                        <img src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/icon/' . $color . '/social/' . strtolower($social_key1) . '.svg') }}"
                                                                            alt="{{ $social_key1 }}"
...
<script src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/modal/bootstrap.min.js') }}"></script>

<script src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/js/jquery.min.js') }}"></script>
<script src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/js/slick.min.js') }}" defer="defer"></script>

@if ($SITE_RTL == 'on')
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/js/rtl-custom.js') }}" defer="defer"></script>
@else
    <script src="{{ asset('Modules/VCard/Resources/assets/custom/theme18/js/custom.js') }}" defer="defer"></script>
@endif
