...
class AIAssistantTemplateListTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $defaultTemplate = [
            [
                'template_name'=>'note',
                'template_module'=>'add note on appointment',
            ...
            [
                'template_name'=>'note',
                'template_module'=>'add note on contact',
            ...
            [
                ...
                'template_module'=>'create business',
            ...
            [
                ...
                'field_json'=>'{"field":[{"label":"Business Name","placeholder":"Nisc ERP","field_type":"text_box","field_name":"name"},{"label":"Providing services","placeholder":"provide best web base development","field_type":"textarea","field_name":"sevices"}]}',
                'is_tone'=> 0,
            ],
            [
            ...
            [
                ...
                'template_module'=>'service business',
        ...
        {
            $check = AssistantTemplate::where('template_module',$temp['template_module'])->where('module','VCard')->where('template_name',$temp['template_name'])->exists();
            if(!$check)
            {
