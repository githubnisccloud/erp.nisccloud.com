...
class AssetHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $assets = AssetHistory::orderBy('id', 'desc')->where('created_by', '=', creatorId())->where('workspace_id',getActiveWorkSpace())->with('modules')->get();
            return view('assets::history.index', compact('assets'));
        }else{
