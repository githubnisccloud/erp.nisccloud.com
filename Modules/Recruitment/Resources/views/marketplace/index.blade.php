            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Speed up your hiring process. Use built-in hiring features to create and manage new job openings and fill
                            your open positions faster. Depending on Hrm Module.')}}</p>
                        <div class="price">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Recruitment Management')}}</h2>
                        </div>
                        <p>{{__('Job Post, Job application, Interview Scheduling, Custom Interview Questions, Job Onboarding, Unique link for applying for a job')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Speed up your hiring process')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Speed up your hiring process. Use built-in hiring features to create and manage new job openings and fill your open positions faster. ')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Candidate pipeline')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Collect and manage applications from start to finish. Easily compare candidates and pick the best one for the job.Create a candidate pipeline. Get a clear view of all the potential candidates and the recruitment stagesthey’re in. ')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Schedule interviews')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Schedule interviews, create interview questions and assign interviewers in just a few clicks.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Job Openings Editor')}}</h2>
                        </div>
                        <p>{{__('Easily add new job openings. Add it to a job board, start tracking applications, and fill the position. Schedule interviews, assign interviewers, and get full control over the recruitment process. Create a pipeline to track every candidate and have a clear view of who progresses to the next stage. ')}}</p>
                    </div>
                </div>
            </div>
        </div>
