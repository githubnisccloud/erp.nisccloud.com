...
<div class="modal-body custom-fields">
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            {{ Form::text('question', '', ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'Enter Question Name']) }}
        </div>
        <div class="col-md-6 form-group">
        ...
        <div class="col-md-12 form-group">
            <div class="field_wrapper" id="available-answer-wrapper">
        ...
        <div class="col-md-6 form-group">
            {{ Form::label('required', __('Required Answer:'), ['class' => 'col-form-label']) }}
        ...
        <div class="col-md-6 form-group">
            {{ Form::label('enable', __('Enabled:'), ['class' => 'col-form-label']) }}
            <div class="form-check form-switch custom-switch-v1">
