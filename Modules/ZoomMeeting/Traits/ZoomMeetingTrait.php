...
trait ZoomMeetingTrait
{
    ...
    public function createmitting($data)
    {
        ...
        $body = [
            ...
            'body'    => json_encode([
                ...
                'timezone'     => !empty(company_setting('timezone'))?company_setting('timezone'):company_setting('defult_timezone'),
                'settings'   => [
    ...
    {
        if (!empty(company_setting('zoom_account_id')) && !empty(company_setting('zoom_client_id')) && !empty(company_setting('zoom_client_secret')))
         {
            // Construct the basic authentication header
            $basicAuthHeader = base64_encode(company_setting('zoom_client_id') . ':' . company_setting('zoom_client_secret'));
            ...
            $response = $this->client->request('POST', 'https://zoom.us/oauth/token', [
                ...
                'form_params' => [
                    ...
                    "account_id" =>  company_setting('zoom_account_id')
                ],
            ]);
