            ...
            <div class="row mt-2">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control company_toyyibpay_secrect_key" placeholder="{{ __('Secrect Key') }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control company_toyyibpay_category_code" placeholder="{{ __('Category Code') }}" name="company_toyyibpay_category_code"
...
<script>
    $(document).on('click', '#toyyibpay_payment_is_on', function() {
        if ($('#toyyibpay_payment_is_on').prop('checked')) {
            $(".company_toyyibpay_secrect_key").removeAttr("disabled");
            $(".company_toyyibpay_category_code").removeAttr("disabled");
        } else {
            $('.company_toyyibpay_secrect_key').attr("disabled", "disabled");
            $('.company_toyyibpay_category_code').attr("disabled", "disabled");
        }
    });
</script>
