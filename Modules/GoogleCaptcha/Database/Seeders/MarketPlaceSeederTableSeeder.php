...
class MarketPlaceSeederTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data['product_main_heading'] = 'GoogleCaptcha';
        $data['product_main_description'] = '<p>The Key pair consists of a site key and secret key. The site key is used to invoke reCAPTCHA service on your site or mobile application.</p>';
        ...
        $data['screenshots'] = '[{"screenshots":"","screenshots_heading":"GoogleCaptcha"},{"screenshots":"","screenshots_heading":"GoogleCaptcha"},{"screenshots":"","screenshots_heading":"GoogleCaptcha"},{"screenshots":"","screenshots_heading":"GoogleCaptcha"},{"screenshots":"","screenshots_heading":"GoogleCaptcha"}]';
        ...
        foreach($data as $key => $value){
            if(!MarketplacePageSetting::where('name', '=', $key)->where('module', '=', 'GoogleCaptcha')->exists()){
