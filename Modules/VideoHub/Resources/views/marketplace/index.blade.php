...
@php
    $path = url("/Modules/VideoHub/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Video Hub makes work quick and easy. If you use video hub you can complete your work on time and save your time. Video Hub saves your videos so you can watch them whenever you need.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Video ')}}<b>{{__('Hub')}}</b>{{__(' Is Useful')}}</h2>
                <p>{{__('Video hub helps in explaining the workflow to anyone like clients, users, employees etc.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Why use Video Hub?')}}</h2>
                        </div>
                        <p>{{__('You can easily explain to the client how your product works, how admin can work, how user can work, how employee can work. When the client is new and it is difficult to explain the complete product flow to him, you can easily and quickly explain the complete product flow to him through Video Hub.')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('How To View Video Details And Add Comments?')}}</h2>
                        </div>
                        <p>{{__('Click on the thumbnail or video title. Then you can see a page similar to the given photo. And you can view video, video description, comment box and easily add comments and files in comment box.')}}</p>
                    </div>
                </div>
