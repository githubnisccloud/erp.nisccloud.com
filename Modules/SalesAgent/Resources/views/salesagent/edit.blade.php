@if(!empty($salesAgent))
    {{Form::model($salesAgent,array('route' => array('salesagents.update', $user->id), 'method' => 'PUT')) }}
@else
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    ...
                    {{Form::text('name',!empty($salesAgent) ? $salesAgent->name : $user->name,array('class'=>'form-control','required'=>'required'))}}
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{Form::email('email',!empty($salesAgent) ? $salesAgent->email : $user->email,array('class'=>'form-control','required'=>'required','placeholder'=>'Enter Email'))}}
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
