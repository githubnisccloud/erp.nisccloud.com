                        ...
                        <ol class="cart-tble-list">
                            @foreach($products['products'] as $key => $product)
                                @php
                                    ...
                                    $course = \Modules\LMS\Entities\Course::find($product['product_id']);
                                @endphp
                                <li class="cart-item">
                                    <div class="cart-item-inner">
                                        <div class="product-image">
                                            <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($product['product_id'])])}}">
                                                ...
                                                @else
                                                    <img src="{{asset('Modules/LMS/Resources/assets/themes/theme4/images/product-3.jpg')}}" width="65%">
                                                @endif
                                            </a>
                                        </div>
                                        <div class="product-cart-summry">
                                            ...
                                            <div class="cart-price">
                                                {{($price>1)? currency_format_with_sym($price,$store->created_by,$store->workspace_id): currency_format_with_sym($price,$store->created_by,$store->workspace_id).'(Free)'}}
                                            </div>
                        ...
                        <div class="cart-summery">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <span class="cart-sum-right">{{ currency_format_with_sym($total,$store->created_by,$store->workspace_id)}}</span>
                                </li>
                            </ul>
