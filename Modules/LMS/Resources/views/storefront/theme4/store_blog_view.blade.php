...
<div class="wrapper">
    <section class="common-banner-section blog-banner" style="background-image:url({{ asset('Modules/LMS/Resources/assets/themes/theme4/images/blog-banner.jpg') }});">
        <div class="container">
            <div class="row">
                        ...
                        <div class="blog-widget-inner">
                            <div class="blog-media">
                                <a href="{{route('store.store_blog_view',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($blogs->id)])}}">
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/blog-image.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="blog-caption">
                                <div class="captio-top d-flex justify-content-between align-items-center">
                                    <span class="badge">{{ __('Articles') }}</span>
                                    <span class="date">{{ company_date_formate($blogs->created_at,$blogs->created_by,$blogs->workspace_id)}}</span>
                                </div>
                                <h4>
