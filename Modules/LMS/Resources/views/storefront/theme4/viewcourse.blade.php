...
@extends('lms::layouts.theme4.shopfront')
@section('meta-data')
    <!-- Primary Meta Tags -->
    <meta name="title" content="{{(!empty($courses->meta_keywords)?$courses->meta_keywords:'')}}">
    <meta name="description" content="{{(!empty($courses->meta_description)?$courses->meta_description:'')}}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:title" content="{{(!empty($courses->meta_keywords)?$courses->meta_keywords:'')}}">
    <meta property="og:description" content="{{(!empty($courses->meta_description)?$courses->meta_description:'')}}">
    @if(!empty($courses->meta_image))
    <meta property="og:image" content="{{get_file($courses->meta_image)}}">
    @endif
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{env('APP_URL')}}">
    <meta property="twitter:title" content="{{(!empty($courses->meta_keywords)?$courses->meta_keywords:'')}}">
    <meta property="twitter:description" content="{{(!empty($courses->meta_description)?$courses->meta_description:'')}}">
    @if(!empty($courses->meta_image))
        <meta property="twitter:image" content="{{get_file($courses->meta_image)}}">
    @else
...
@endsection
@push('css-page')
<link rel="stylesheet" href="{{asset('Modules/LMS/Resources/assets/themes/theme4/css/moovie.css')}}">
    <style>
        .divider-vertical {
            left: 50%;
            top: 10%;
...
@endpush
@push('script-page')
    <script src="{{asset('Modules/LMS/Resources/assets/themes/theme4/js/moovie.js')}}"></script>
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            var demo1 = new Moovie({
                ...
                icons: {
                    path: '{{ asset("/Modules/LMS/Resources/assets/imgs") }}/'
                }
            });
        });
        @endif
                    ...
                    <div class="pdp-summery">
                        <div class="pdp-summery-top">
                            ...
                            <div class="pdp-subtitles d-flex align-items-center">
                                <span class="subtitle"> {{ !empty($course->category)?$category_name->name:''}}</span>
                                ...
                                <div class="user-review-content">
                                    <div class="abt-user">
                                        <div class="abt-usr-image">
                                            <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/amelie.png') }}" alt="user">
                                        </div>
                                        <div class="user-info">
                                            <h4>
                                            ...
                                            <div class="course-reviews">
                                                ...
                                                <div class="course-review-profile">
                                                    <div class="course-review-profile-img">
                                                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/amelie.png') }}" alt="">
                                                    </div>
                                                    <div class="user-info">
                                                        <h4>
                                                            {{$course_rating->name}}
                    ...
                    <div class="pdp-main-itm">
                        <div class="pdp-main-media">
                            @if(!empty($course->thumbnail))
                                <img alt="Image placeholder" src="{{get_file($course->thumbnail)}}" class="img-fluid">
                            @else
                                <img src="{{asset('Modules/LMS/Resources/assets/themes/theme4/images/product-3.jpg')}}" alt="card" class="img-fluid">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="description-image-right">
                        @if($course->is_preview == 'on')
                            @if($course->preview_type == 'Video File')
                                <video id="example" class="preview_video" poster="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/poster.jpg') }}" controls="" controlslist="nodownload" style="display: none;">
                                    <source src="{{get_file($course->preview_content)}}" type="video/mp4">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="syllabus-left-side">
                        ...
                        <p>{{__('This is CS50x , Harvard University')}}'{{__('s introduction to the intellectual enterprises of computer science and the art of programming for majors and non-majors alike, with or without prior programming experience. An entry-level course taught by David J. Malan, CS50x teaches students how to think algorithmically and solve problems efficiently. Topics include abstraction, algorithms, data structures, encapsulation, resource management, security, software engineering, and web development. Languages include C, Python, SQL, and JavaScript plus CSS and HTML. Problem sets inspired by real-world domains of biology, cryptography, finance, forensics, and gaming. The on-campus version of CS50x , CS50, is Harvard')}}'{{__('s largest course')}}.</p>

                        <p>{{__('Students who earn a satisfactory score on 9 problem sets (i.e., programming assignments) and a final project are eligible for a certificate. This is a self-paced course–you may take CS50x on your own schedule.')}}</p>
                        ...
                        <div class="col-md-4 col-sm-6 col-12  educator-card">
                            <div class="educator-card-inner">
                                <div class="educator-image">
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/poster.jpg') }}" alt="">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="newsletter-img">
                                @if($homepage_email_subscriber_Bckground_Image)
                                    <img src="{{get_file($homepage_email_subscriber_Bckground_Image)}}">
                                @else
                                    @if(!empty($store->sub_img))
                                        <img src="{{get_file($store->sub_img)}}" alt="newsletter">
                                    @else
