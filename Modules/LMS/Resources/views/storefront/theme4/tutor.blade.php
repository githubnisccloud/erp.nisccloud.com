                                        ...
                                        <div class="product-card-inner">
                                            <div class="product-img">
                                                <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/product-1.jpg') }}" alt="">
                                                </a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="newsletter-img">
                                    ...
                                    @else
                                        ...
                                        @else
                                            <img src="{{asset('Modules/LMS/Resources/assets/themes/'.$store->theme_dir.'/images/side-image-1.png')}}" alt="newsletter">
                                        @endif
                                    @endif
                                </div>
                            </div>
