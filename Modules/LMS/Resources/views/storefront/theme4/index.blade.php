                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-4 col-12 d-none-responsive">
                            <div class="banner-left-side">
                                <div class="banner-sub-imgs">
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/side-image-1.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12">
                            <div class="banner-left-side">
                                <div class="banner-sub-imgs">
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/side-image-2.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="category-img">
                                            <a href="#">
                                                @if(!empty($category->category_image))
                                                    <img alt="Image placeholder" src="{{get_file($category->category_image)}}" class="img-fluid">
                                                @else
                                                    <img src="{{asset('Modules/LMS/Resources/assets/themes/theme4/images/product-2.jpg')}}" alt="business" class="img-fluid">
                                                @endif
                                            </a>
                                        </div>
                                                    ...
                                                    <div class="product-card-inner">
                                                        <div class="product-img">
                                                            <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}" tabindex="0">
                                                                ...
                                                                @else
                                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/product-5.jpg') }}" alt="card">
                                                                @endif
                                                            </a>
                                                            <div class="subtitle-top d-flex align-items-center justify-content-between">
                                                                <span class="badge">{{!empty($course->category)? $course->category_name:'-'}}</span>
