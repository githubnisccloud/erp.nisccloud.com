...
@endsection
@push('css-page')
    <script src="{{ asset('Modules/LMS/Resources/assets/js/bootstrap-bundle-min.5.0.1.js') }}"></script>
                            ...
                            <!-- Download Button -->
                                @if (count($cs_incomplete) == 0 && $progress == 100)
                                    <div class="download-btn">
                                        <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}"
                                ...
                                @elseif(count($cs_incomplete) == 1)
                                    <div class="download-btn">
                                        <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}" target="_blank" class="btn d-none">{{ __('Download') }}  <svg xmlns="http://www.w3.org/2000/svg" id="icons" height="512"
                                            viewBox="0 0 24 24" width="512">
                                            <path d="m21 19h-18a1 1 0 0 0 0 2h18a1 1 0 0 0 0-2z" />
                                            <path d="m12 2a1 1 0 0 0 -1 1v10.59l-3.29-3.3a1 1 0 0 0 -1.42 1.42l5 5a1 1 0 0 0 1.42 0l5-5a1 1 0 0 0 -1.42-1.42l-3.29 3.3v-10.59a1 1 0 0 0 -1-1z" />
                                        </svg></a>
                                ...
                                <div class="download-btn certificate_btn d-none">
                                    <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}" target="_blank" class="btn">{{ __('Download') }}  <svg xmlns="http://www.w3.org/2000/svg" id="icons" height="512"
                                        viewBox="0 0 24 24" width="512">
                                        <path d="m21 19h-18a1 1 0 0 0 0 2h18a1 1 0 0 0 0-2z" />
                                        <path d="m12 2a1 1 0 0 0 -1 1v10.59l-3.29-3.3a1 1 0 0 0 -1.42 1.42l5 5a1 1 0 0 0 1.42 0l5-5a1 1 0 0 0 -1.42-1.42l-3.29 3.3v-10.59a1 1 0 0 0 -1-1z" />
                                    </svg></a>
                    ...
                    <div class="{{!empty($current_chapter->type == 'Video File' || $current_chapter->type == 'Text Content')? $current_chapter->type == 'Video File':'chapter-video-media'}}">
                        @if ($current_chapter->type == 'Video File')
                            <video id="example" class="preview_video" height="500"
                                poster="{{ asset('Modules/LMS/Resources/assets/img/video-img.png') }}">
                                <source
                                    src="{{ get_file($current_chapter->video_file) }}"
                                    type="video/mp4">
                        ...
                        @elseif($current_chapter->type == 'Video Url')
                            ...
                            @php
                                ...
                                elseif (strpos($current_chapter->video_url, 'src') == false && strpos($current_chapter->video_url, 'embed') !== false )
                                {
                                    $video_url = str_replace('https://www.youtube.com/embed/','',$current_chapter->video_url);
                                }
                                else
                                {
                                    $video_url = str_replace('https://youtu.be/','', str_replace('https://www.youtube.com/watch?v=','' ,$current_chapter->video_url));
                                    preg_match('/[\\?\\&]v=([^\\?\\&]+)/', $current_chapter->video_url, $matches);
                                    if(count($matches) > 0)
                                    {
                                        $videoId = $matches[1];
                                        ...
                                        @foreach ($header->chapters_data as $k => $chapters)
                                            <div class="chapter-topics">
                                                ...
                                                <div class="checkbox-custom">
                                                    @php
                                                        $chapter_status_check = \Modules\LMS\Entities\Chapters::chapterstatus($chapters->id);
                                                    @endphp
                        ...
                        @foreach ($practices_files as $practices_file)
                            <div class="course-download-card">
                                <div class="course-image">
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/images/pdf-image.png') }}"  alt="">
                                </div>
                                <div class="corse-caption">
                                    <div class="caption-left">
                                        <h5>
                                            <a class="action-item" href="{{ get_file($practices_file->files) }}"></a>
                                        </h5>
                                        <span>({{ $practices_file->file_name }})</span>
                                    </div>
                                    <div class="btn-wrap">
                                        <a href="{{ get_file($practices_file->files) }}" class="btn-ic">
