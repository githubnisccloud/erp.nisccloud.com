        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-12">
                    ...
                    @if (!empty($company_setting['bank_transfer_payment_is_on']) && $company_setting['bank_transfer_payment_is_on'] == 'on' &&
                                            ...
                                            <div class="mini-cart-item">
                                                <div class="mini-cart-image">
                                                    <a
                                                        ...
                                                        @else
                                                            <img src="{{ asset('Modules/LMS/Resources/assets/imgs/courses.png')}}" alt="img">
                                                        @endif
                                                    </a>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="mini-total-price" id="total_value"
                                            ...
                                            <span class="total_price" data-value="{{ $total }}" >
                                                {{ currency_format_with_sym($total,$store->created_by,$store->workspace_id) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
