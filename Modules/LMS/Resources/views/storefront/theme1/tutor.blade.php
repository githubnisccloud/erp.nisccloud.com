                            ...
                            <div class="user-profile">
                                <div class="user-image">
                                    @if(!empty($tutor->avatar))
                                        <img src="{{get_file($tutor->avatar)}}" alt="user">
                                    @else
                                        <img src="{{asset('Modules/LMS/Resources/assets/img/user.png')}}" alt="user">
                                    @endif
                                </div>
                                <div class="user-info-main">
                                    ...
                                    <ul class="user-tags">
                                        ...
                                        <li><span class="badge">{{!empty($tutor_course->category_id)?$tutor_course->category_id->name:''}}</span></li>
                                    </ul>
                                </div>
                          </div>
                        </div>
                                                ...
                                                <div class="course-widget-inner">
                                                    <div class="course-media">
                                                        <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}" tabindex="0">
                                                            @if(!empty($course->thumbnail))
                                                                <img src="{{get_file($course->thumbnail)}}" alt="card">
                                                            @else
                                                    ...
                                                    <div class="course-caption">
                                                        ...
                                                        <div class="price-addtocart d-flex align-items-center justify-content-between">
                                                            <div class="price">
                                                                <ins> <span class="currency-type">{{ currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</span></ins>
                                                            </div>
                                                            @php
