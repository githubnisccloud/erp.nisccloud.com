...
@extends('lms::layouts.theme1.shopfront')
@section('meta-data')
    <!-- Primary Meta Tags -->
...
@endpush
@push('script-page')
    <script src="{{asset('Modules/LMS/Resources/assets/js/moovie.js')}}"></script>
    <script>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    <div class="common-banner-content">
                        ...
                        <span class="badge">  {{ !empty($course->category)?$category_name->name:''}}</span>
            ...
            <div class="banner-image">@php
                ...
                @if($data[0]=='yellow-style')
                    <img src="{{ asset('Modules/LMS/Resources/assets/imgs/Male-Running-common1.png') }}" alt="">
                @elseif($data[0]=='blue-style')
                    <img src="{{ asset('Modules/LMS/Resources/assets/imgs/Male-Running-common2.png') }}" alt="">
                @else
                    <img src="{{ asset('Modules/LMS/Resources/assets/imgs/Male-Running-common3.png') }}" alt="">
                @endif
            </div>
        </div>
    </section>
                        ...
                        <div class="pdp-main-media">
                            @if($course->is_preview == 'on')
                                @if($course->preview_type == 'Video File')
                                    <video id="example" class="preview_video" poster="{{asset('Modules/LMS/Resources/assets/imgs/video-img.png')}}" controls controlsList="nodownload">
                                ...
                                <div class="user-review-content">
                                    <div class="abt-user">
                                        <div class="abt-usr-image">
                                            <img @if($course->tutor_id->avatar)src="{{get_file($course->tutor_id->avatar)}}"@else src="{{asset('Modules/LMS/Resources/assets/img/user.png')}}"@endif alt="user">
                                        </div>
                                        <div class="user-info">
                                            <h4>
                                            ...
                                            <div class="course-reviews">
                                                <div class="courser-top-content d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="course-review-star">
                                                        ...
                                                        @if(Auth::check())
                                                            <a  class="action-item mr-2" data-target="#commonModalBlur" data-toggle="modal" data-modal="Edit Rating" data-url="{{route('rating.edit',$course_rating->id)}}" data-ajax-popup-blur="true" data-title="{{__('Edit Rating')}}">
                ...
                <div class="col-xl-4 col-lg-4 col-12 pdp-right-side">
                    <div class="pdp-summery">
                        ...
                        <div class="pdp-summery-bottom">
                            <div class="price">
                                <ins> <span class="currency-type">{{ ($course->is_free == 'on')? 'Free' : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</span></ins>
                            </div>
                                ...
                                <div class="course-media">
                                    <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course_by_cat->id)])}}">
                                        @if(!empty($course_by_cat->thumbnail))
                                            <img src="{{get_file($course_by_cat->thumbnail)}}" alt="card">
                                        @else
                                            <img src="{{asset('Modules/LMS/Resources/assets/img/card-img.svg')}}" alt="card" class="img-fluid">
                                        @endif
                                    </a>
                                </div>
                                            ...
                                            <ins>
                                                <span class="currency-type">
                                                    @if($course_by_cat->has_discount == 'on')
                                                        {{ ($course_by_cat->is_free == 'on')? __('Free') : currency_format_with_sym($course_by_cat->price,$store->created_by,$store->workspace_id)}}
                                                        <small>
                                                            <del>{{ currency_format_with_sym( $course_by_cat->discount,$store->created_by,$store->workspace_id)}}</del>
                                                        </small>
                                                    @else
                                                        {{ ($course_by_cat->is_free == 'on')? __('Free') : currency_format_with_sym($course_by_cat->price,$store->created_by,$store->workspace_id)}}
                                                    @endif
