                    ...
                    <div class="col-lg-7 banner-left-side col-md-6 col-12">
                        ...
                        <div class="banner-image-left">
                            ...
                            @if(!empty($homepage_header_Bckground_Image))
                                <img src="{{get_file($homepage_header_Bckground_Image)}}">
                            @else
                                @if($data[0]=='green-style')
                                    <img src="{{asset('Modules/LMS/Resources/assets/imgs/MaleRunning3.png')}}" alt="">
                                @elseif($data[0]=='blue-style')
                                    <img src="{{asset('Modules/LMS/Resources/assets/imgs/MaleRunning2.png')}}" alt="">
                                @else
                                    <img src="{{asset('Modules/LMS/Resources/assets/imgs/MaleRunning1.png')}}" alt="">
                                @endif
                            @endif
                                    ...
                                    <div class="course-media">
                                        ...
                                        <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                            @if(!empty($course->thumbnail))
                                                <img alt="card" src="{{get_file($course->thumbnail)}}"
                                                class="img-fluid">
                                            @else
                                                ...
                                                @else
                                                    <div class="price">
                                                        @if($course->has_discount == 'on')
                                                            <ins> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</ins>
                                                        @else
                                                            <ins> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</ins>
                                                        @endif
                                                    </div>
                                    ...
                                    <div class="knowledge-top-content">
                                        <div class="knowledge-icon">
                                            @if(!empty($category->category_image))
                                                <img alt="Image placeholder" src="{{get_file($category->category_image)}}">
                                            @else
                                                <img src="{{asset('Modules/LMS/Resources/assets/img/business.svg')}}" alt="business" class="img-fluid">
                                            @endif
                                        </div>
                                ...
                                <div class="course-widget">
                                    <div class="course-widget-inner">
                                        <div class="course-media">
                                            <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                                @if(!empty($course->thumbnail))
                                                    <img alt="Image placeholder" src="{{get_file($course->thumbnail)}}">
                                                @else
                                                    <img src="{{asset('Modules/LMS/Resources/assets/img/card-img.svg')}}" alt="card">
                                                @endif
                                            </a>
                                        </div>
                                        <div class="course-caption">
                            ...
                            <div class="newsletter-image">
                                @if($homepage_email_subscriber_box == 'on')
                                    ...
                                    @else
                                        ...
                                        @else
                                            <img src="{{asset('Modules/LMS/Resources/assets/image/'.$store->theme_dir.'/img/newsletter.png')}}" alt="newsletter">
                                        @endif
                                    @endif
                                @endif
                            </div>
