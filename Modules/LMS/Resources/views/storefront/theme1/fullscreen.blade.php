                    ...
                    <div class="chapter-head-block pagination">
                        @if(count($cs_incomplete) == 0 && $progress == 100)
                            <div class="download-btn">
                                <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}" target="_blank" class="btn btn_certi certificate_dl">{{ __('Download') }}</a>
                            </div>
                        @elseif(count($cs_incomplete) == 1)
                            <div class="download-btn">
                                <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}" target="_blank" class="btn d-none">{{ __('Download') }}</a>
                            </div>
                        @endif
                        <div class="download-btn certificate_btn d-none">
                            <a href="{{ route('certificate.pdf',[$courses->id, Crypt::encrypt($store->certificate_template)]) }}" target="_blank" class="btn">{{ __('Download') }}</a>
                        </div>
                    ...
                    <div class="pdp-main-itm">
                        <div class="pdp-main-media {{!empty($current_chapter->type == 'Video File')? $current_chapter->type == 'Video File':'chapter-video'}}">
                            @if($current_chapter->type == 'Video File')
                                <video id="example" class="preview_video" height="500" poster="{{asset('Modules/LMS/Resources/assets/img/video-img.png')}}">
                                    <source src="{{get_file($current_chapter->video_file)}}" type="video/mp4">
                        ...
                        @if($practices_files->count()>0)
                            ...
                            <div class="fil-title">
                                <div class="corse-caption-top">
                                    <img src="{{asset('Modules/LMS/Resources/assets/img/project-files.svg')}}" alt="">
                                    ...
                                    @foreach($practices_files as $practices_file)
                                        <div class="course-download-card" data-id="{{$practices_file->id}}">
                                            <div class="course-image">
                                                <a class="action-item" href="{{get_file($practices_file->files)}}">
                                                    <img src="{{asset('Modules/LMS/Resources/assets/img/ai.svg')}}" alt="ai" class="img-fluid">
                                                </a>
                                            </div>
