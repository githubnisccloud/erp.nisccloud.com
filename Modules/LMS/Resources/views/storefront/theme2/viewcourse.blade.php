...
@extends('lms::layouts.theme2.shopfront')
...
@section('meta-data')
    ...
    @else
        <meta property="twitter:image" content="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/bachelor-of-sci.jpg') }}">
    @endif
@endsection
@section('page-title')
...
@endpush
@push('script-page')
    <script src="{{asset('Modules/LMS/Resources/themes/theme2/js/moovie.js')}}"></script>
    <script>
                                    ...
                                    <div class="user-review-content">
                                        <div class="abt-user">
                                            <div class="abt-usr-image">
                                                <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/amelie.png') }}" alt="user">
                                            </div>
                                            <div class="user-info">
                                                <h4>
                                                ...
                                                <div class="course-reviews">
                                                    ...
                                                    <div class="course-review-profile">
                                                        <div class="course-review-profile-img">
                                                            <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/amelie.png') }}" alt="">
                                                        </div>
                                                        <div class="user-info">
                                                            <h4>
                                                                {{$course_rating->name}}
                    ...
                    <div class="col-xl-5 col-lg-5 col-12 pdp-right-side">
                        <div class="pdp-main-itm">
                            <div class="pdp-main-media">
                                ...
                                @else
                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/bachelor-of-sci.jpg') }}" alt="">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="description-image-right">
                            @if($course->is_preview == 'on')
                                @if($course->preview_type == 'Video File')
                                    <video id="example" class="preview_video" poster="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/poster.jpg') }}" controls="" controlslist="nodownload">
                                ...
                                <div class="col-md-4 col-sm-6 col-12  educator-card">
                                    <div class="educator-card-inner">
                                        <div class="educator-image">
                                            <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/poster.jpg') }}" alt="">
