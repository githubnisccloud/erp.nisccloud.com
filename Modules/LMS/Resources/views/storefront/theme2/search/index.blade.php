...
@section('content')
    ...
    <div class="wrapper" id="wrap">
        <section class="common-banner-section product-list-page"  style="background-image:url({{ asset('Modules/LMS/Resources/assets/themes/theme2/images/comman-banner.png') }});">
            <div class="container">
                <div class="row">
                                ...
                                <div class="pro-itm">
                                    ...
                                    <ul class="pro-itm-inner">
                                        @php
                                            $i = 0
                                        @endphp
                                        @foreach( \Modules\LMS\Entities\LmsUtility::course_level() as $level)
                                            <li>
                                                <div class="checkbox-custom">
                                        ...
                                        <div class="product-img">
                                            <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                                ...
                                                @if(!empty($course->thumbnail))
                                                    <img src="{{get_file($course->thumbnail)}}" alt="card" class="img-fluid">
                                                @else
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-content-bottom">
                                                ...
                                                <div class="price-addtocart">
                                                    <div class="price">
                                                        <ins> <span class="currency-type">{{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</span></ins>
                                                    </div>
                                                    @if(Auth::guard('students')->check())
