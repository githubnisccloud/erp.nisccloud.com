...
@section('content')
    <div class="wrapper" id="wrap">
        <section class="common-banner-section tutor-banner" style="background-image:url({{ asset('Modules/LMS/Resources/assets/themes/theme2/images/comman-banner.png') }}) ;">
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="product-card-inner">
                                            <div class="product-img">
                                                <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/product-1.jpg') }}" alt="">
                                                </a>
