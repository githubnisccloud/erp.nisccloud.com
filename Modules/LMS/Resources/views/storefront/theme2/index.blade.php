...
@endsection
@php
    $default =get_file('Modules/LMS/Resources/assets/image/theme2/header/brand_logo.png');
@endphp
@push('script-page')
    <!-- CART -->
    <script>
...
@section('content')
    <div class="home-wrapper">
        ...
        @php
            ...
            $a[2] = '#';
            $a[3] = '#';
            $img[0] = 'Modules/LMS/Resources/assets/image/theme2/images/data-analyst.jpg';
            $img[1] = 'Modules/LMS/Resources/assets/image/theme2/images/data-analyst.jpg';
            $img[2] = 'Modules/LMS/Resources/assets/image/theme2/images/data-analyst.jpg';
            $img[3] = 'Modules/LMS/Resources/assets/image/theme2/images/data-analyst.jpg';
            ...
            <section class="main-home-first-section padding-top">
                <div class="banner-image">
                    ...
                    @if($data[0]=='dark-blue-color')
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/banner-image1.png') }}" alt="">
                    @elseif($data[0]=='dark-green-color')
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/banner-image2.png') }}" alt="">
                    @else
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/banner-image3.png') }}" alt="">
                    @endif
                </div>
                <div class="container">
                                    ...
                                    @foreach ($storethemesetting['inner-list'] as $image)
                                        @if (!empty($image['image_path']))
                                            ...
                                            <div class="client-logo-item">
                                                    <a href="#">
                                                        <img src="{{(!empty($img) ? $img : 'brand_logo.png') }}" alt="">
                                                    </a>
                                                </div>
                                            @endforeach
                                        @else
                                        ...
                                        <div class="product-img">
                                            <a href="{{route('store.search',[$store->slug])}}">
                                                @if(!empty($course->thumbnail))
                                                    <img alt="card" src="{{get_file($course->thumbnail)}}" class="img-fluid">
                                                @else
                                            ...
                                            <div class="subtitle-top d-flex align-items-center justify-content-between">
                                                <span class="badge">{{!empty($course->category)?$course->category_name:'-'}}</span>
                                                    ...
                                                    @else
                                                        <div class="card-price">
                                                            @if($course->has_discount == 'on')
                                                                <h3> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</h3>
                                                            @else
                                                                <h3> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</h3>
                                                            @endif
                                                        </div>
                                                ...
                                                <div class="testimonial-card-inner">
                                                    <div class="user-img">
                                                        @if(!empty($category->category_image))
                                                            <img alt="Image placeholder" src="{{get_file($category->category_image)}}" class="myimage img-fluid">
                                                        @else
                                                            <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/data-analyst.jpg') }}" alt="">
                                                        @endif
                                                    </div>
        ...
        @if($onsale_course_enable == 'on')
            <section class="home-category-section padding-bottom">
                                    ...
                                    <div class="category-itm-inner">
                                        <div class="category-content-top">
                                            <div class="category-img">
                                                ...
                                                @else
                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/category-1.jpg') }}" alt="">
                                                @endif
                                            </div>
                                            <div class="category-content-inner">
                                                <h5>{{!empty($course->category)? $course->category_name:'-'}}</h5>
                                                    ...
                                                    @else
                                                        <div class="card-price">
                                                            @if($course->has_discount == 'on')
                                                                <h3> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</h3>
                                                                <sub>
                                                                    <del> {{ currency_format_with_sym($course->discount,$store->created_by,$store->workspace_id)}} </del>
                                                                </sub>
                                                            @else
                                                                <h3> {{ ($course->is_free == 'on')? __('Free') : currency_format_with_sym($course->price,$store->created_by,$store->workspace_id)}}</h3>
                                                                <sub>
                ...
                <div class="shape-image">
                    ...
                    @if($data[0]=='dark-blue-color')
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/section-shape-left.png') }}" alt="">
                    @elseif($data[0]=='dark-green-color')
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/section-shape-left2.png') }}" alt="">
                    @else
                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/section-shape-left3.png') }}" alt="">
                    @endif
