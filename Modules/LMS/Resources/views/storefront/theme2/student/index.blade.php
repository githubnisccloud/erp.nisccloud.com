...
@section('content')
    ...
    <div class="wrapper">
        <section class="common-banner-section" style="background-image:url({{ asset('Modules/LMS/Resources/assets/themes/theme2/images/comman-banner.png') }});">
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="product-content">
                                        <div class="product-content-top">
                                            <div class="review-rating">
                                                ...
                                                @php
                                                    $tutor_course_count = \Modules\LMS\Entities\Course::where('workspace_id', $store->workspace_id)->where('created_by', $purchased_course->created_by)->where('status', 'Active')->get();
                                                    $tutor_id           = $tutor_course_count->pluck('created_by')->first();
                                                    $tutor_count_rating = \Modules\LMS\Entities\Ratting::where('tutor_id', $tutor_id)->where('course_id',$purchased_course->id)->where('slug', $store->slug)->where('rating_view', 'on')->count();
                                                @endphp
