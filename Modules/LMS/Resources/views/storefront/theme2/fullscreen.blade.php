...
@endpush
@push('script-page')
    <script src="{{asset('Modules/LMS/Resources/assets/themes/theme2/js/moovie.js')}}"></script>
    <script>
                            ...
                            @foreach ($practices_files as $practices_file)
                                <div class="course-download-card" data-id="{{ $practices_file->id }}">
                                    <div class="course-image">
                                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/pdf-image.png') }}" alt="">
                                    </div>
                                    <div class="corse-caption">
                                        <div class="caption-left">
                                            <h5>
                                                <a class="action-item"
                                                    href="{{ get_file($practices_file->files) }}"></a>
                                            </h5>
