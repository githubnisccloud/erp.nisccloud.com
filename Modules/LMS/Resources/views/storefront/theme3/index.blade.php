                            ...
                            <div class="advance-search">
                                <div class="advance-search-back">
                                    <div class="advance-search-image">
                                        ...
                                        @else
                                            <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme3/images/banner-img.jpg') }}" alt="">
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card-inner">
                                    <div class="product-img">
                                        <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                            ...
                                            @else
                                                <img src="{{asset('Modules/LMS/Resources/assets/themes/theme3/images/bachelor-of-sci.jpg')}}" alt="card" class="img-fluid">
                                            @endif
                                        </a>
                                ...
                                <div class="category-card-inner">
                                    <div class="category-img">
                                        <a href="#">
                                            ...
                                            @else
                                                <img src="{{asset('Modules/LMS/Resources/assets/themes/theme3/images/product-2.jpg')}}" alt="business" class="img-fluid">
                                            @endif
                                        </a>
                                    </div>
                                        ...
                                        <div class="product-card-inner">
                                            <div class="product-img">
                                                <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">
                                                    ...
                                                    @else
                                                        <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme3/images/google-ux.png') }}" alt="card">
                                                    @endif
                                                </a>
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div class="university-logo">
                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme3/images/Google_ G _Logo.png') }}" alt="">
                                                </div>
                                                    <h4>
                                                        <a href="{{route('store.viewcourse',[$store->slug,\Illuminate\Support\Facades\Crypt::encrypt($course->id)])}}">{{$course->title}}</a>
                                                    </h4>
