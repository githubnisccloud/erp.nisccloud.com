...
<!DOCTYPE html>
<html lang="en">
    @include('lms::layouts.theme1.shophead')
    <body class="loaded">
        @include('lms::layouts.theme1.shopheader')
        <div class="wrapper">
            @yield('content')
        </div>
        ...
        <script> app_url = "{{asset('Modules/LMS/Resources/assets/img/')}}" </script>
        <script src="{{asset('js/jquery.min.js') }}"></script>
        <script src="{{asset('Modules/LMS/Resources/assets/js/bootstrap.min.js')}}"></script>
        ...
        <script src="{{asset('Modules/LMS/Resources/assets/js/lmscustom.js')}}"></script>
