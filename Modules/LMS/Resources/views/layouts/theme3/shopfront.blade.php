...
<html lang="en" dir="{{env('SITE_RTL') == 'on'?'rtl':''}}">
    @include('lms::layouts.theme3.shophead')
    <body>
        @include('lms::layouts.theme3.shopheader')
                            ...
                            <div class="footer-logo footer-col">
                                <a href="{{route('store.slug',$store->slug)}}">
                                    @if(!empty($getStoreThemeSetting[5]['inner-list'][0]['field_default_text']))
                                        <img src="{{get_file($getStoreThemeSetting[5]['inner-list'][0]['field_default_text'])}}" alt="lmsgo-logo">
                                    @else
                                        <img src="{{asset('Modules/LMS/Resources/assets/image/theme1/footer/lmsgo-logo.svg')}}" alt="Footer logo">
                                    @endif
                                </a>
                            </div>
            ...
            <div class="mobile-menu-bar">
                <ul>
                    ...
                    @if($page_slug_urls->count()>0)
                        ...
                        @endforeach
                    @endif
                    @if($store->blog_enable == 'on' && $blog_count>0)
                        <li class="menu-lnk">
        ...
        <script src="{{asset('Modules/LMS/Resources/assets/js/bootstrap.min.3.3.5.js')}}"></script>
        <!-- site JS -->
        <script src="{{ asset('Modules/LMS/Resources/assets/js/bootstrap-notify/bootstrap-notify.min.js')}}"></script>

            <script src="{{ asset('market_assets/js/slick.min.js') }}"></script>
            <script src="{{ asset('Modules/LMS/Resources/assets/themes/theme3/js/custom.js') }}"></script>
