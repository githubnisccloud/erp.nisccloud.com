...
<!DOCTYPE html>
<html lang="en" >
    @include('lms::layouts.theme2.shophead')
    <body>
        @include('lms::layouts.theme2.shopheader')
                            ...
                            <div class="footer-logo footer-col">
                                <a href="{{route('store.slug',$store->slug)}}">
                                    @if(!empty($getStoreThemeSetting[6]['inner-list'][0]['field_default_text']))
                                        <img src="{{get_file($getStoreThemeSetting[6]['inner-list'][0]['field_default_text'])}}" alt="lmsgo-logo">
                                    @else
        ...
        <script src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/js/custom.js') }}"></script>
