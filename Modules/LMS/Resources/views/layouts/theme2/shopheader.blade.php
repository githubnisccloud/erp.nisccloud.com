        ...
        <div class="header-top-row">
            <div class="logo-col">
                <h1>
                    <a href="{{route('store.slug',$store->slug)}}">
                        @if(!empty($store->logo))
                            <img alt="lmsgo-logo" src="{{get_file($store->logo.'?'. time())}}" id="img-fluid">
                        @else
                            <img alt="lmsgo-logo" src="{{asset('Modules/LMS/Resources/assets/image/logo.png')}}" id="img-fluid">
                        @endif
                    </a>
                </h1>
            </div>
            <div class="search-form-wrapper">
                <form action="{{route('store.search',[$store->slug])}}" method="get">
                    <div class="form-inputs">
                        <input type="search" placeholder="Search Product..." class="form-control" name="search" id="search_box">
            ...
            <div class="top-navigationbar">
                ...
                <ul class="menu-right d-flex  justify-content-end align-items-center">
                    ...
                    @if( \Modules\LMS\Entities\LmsUtility::StudentAuthCheck($store->slug)==true)
                        <li class="course-header">
                            <a href="{{route('student.home',$store->slug)}}">
                                ...
                                {{ __('My courses') }}
                                <span class="count"> {{\Modules\LMS\Entities\Course::courseCount()}}</span>
                            </a>
                        </li>
                        <li class="wishlist-header">
                            <a href="{{route('student.wishlist',$store->slug)}}">
                                ...
                                {{ __('Wishlist') }}
                                <span class="count wishlist_item_count">{{\Modules\LMS\Entities\Wishlist::wishCount()}}</span>
                            </a>
                        </li>
                    @endif
                        ...
                        <li class="profile-header has-item">
                            ...
                            <div class="menu-dropdown">
                                <ul>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="user-image">
                                                @if(!empty(Auth::guard('students')->user()->avatar))
                                                    <img src="{{get_file(Auth::guard('students')->user()->avatar)}}" alt="user" class="img-fluid">
                                                @else
                                                    <img src="{{asset('Modules/LMS/Resources/assets/themes/theme2/images/amelie.png')}}" alt="user" class="img-fluid">
                                                @endif
                                            </div>
                                    ...
                                    <li>
                                        @if( \Modules\LMS\Entities\LmsUtility::StudentAuthCheck($store->slug) == false)
                    ...
                    <li class="language-header has-item">
                        <a href="javascript:void(0)">
                            ...
                            <span class="select">{{Str::upper($lang)}}</span>
                        </a>
                        <div class="menu-dropdown">
                            <ul>
                                @foreach($languages as $code => $language)
                                    <li>
                                        <a href="{{route('change.languagestore',[$store->slug,$code])}}" class="@if($code == $currantLang) active-language active @endif">
                                            {{ucfirst($language)}}
                                        </a>
                                    </li>
                                @endforeach
                            ...
                            <div class="menu-dropdown">
                                <ul>
                                    <li class="dropdown-user-dtl">
                                        <div class="d-flex align-items-center">
                                            <div class="user-image">
                                                {{-- <img src="assets/images/amelie.png" alt=""> --}}
                                                @if(!empty(Auth::guard('students')->user()->avatar))
                                                    <img src="{{get_file(Auth::guard('students')->user()->avatar)}}" alt="user" class="img-fluid">
                                                @else
                                                    <img src="{{ asset('Modules/LMS/Resources/assets/themes/theme2/images/amelie.png') }}" alt="user" class="img-fluid">
                                        ...
                                        @else
                                            <a href="#" onclick="event.preventDefault(); document.getElementById('student-frm-logout').submit();">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.1096 13.7506C10.6155 13.7315 11.0411 14.1261 11.0602 14.632C11.1033 15.7725 11.1638 16.605 11.2232 17.2018C11.2818 17.7895 11.6366 18.1432 12.1312 18.2036C12.7144 18.2749 13.5372 18.3333 14.6662 18.3333C15.7953 18.3333 16.618 18.2749 17.2012 18.2036C17.6956 18.1432 18.0506 17.7894 18.1092 17.2015C18.2195 16.0937 18.3329 14.1797 18.3329 11C18.3329 7.82021 18.2195 5.90623 18.1092 4.79841C18.0506 4.21051 17.6956 3.85671 17.2012 3.79627C16.618 3.72498 15.7953 3.66662 14.6662 3.66662C13.5372 3.66662 12.7144 3.72497 12.1312 3.79627C11.6366 3.85673 11.2818 4.21037 11.2232 4.79813C11.1638 5.39495 11.1033 6.22737 11.0602 7.36787C11.0411 7.87377 10.6155 8.2684 10.1096 8.24931C9.60374 8.23021 9.20911 7.80461 9.2282 7.29871C9.2724 6.1281 9.33505 5.25743 9.39891 4.61639C9.53316 3.26874 10.4728 2.15202 11.9088 1.97648C12.5772 1.89477 13.4753 1.83329 14.6662 1.83329C15.8572 1.83329 16.7552 1.89477 17.4237 1.97649C18.8598 2.15205 19.7992 3.26929 19.9335 4.61668C20.0517 5.80308 20.1662 7.78106 20.1662 11C20.1662 14.2189 20.0516 16.1968 19.9335 17.3832C19.7992 18.7306 18.8598 19.8479 17.4237 20.0234C16.7552 20.1051 15.8572 20.1666 14.6662 20.1666C13.4753 20.1666 12.5772 20.1051 11.9088 20.0234C10.4728 19.8479 9.53316 18.7312 9.39891 17.3835C9.33505 16.7425 9.2724 15.8718 9.2282 14.7012C9.20911 14.1953 9.60374 13.7697 10.1096 13.7506Z" fill="#FE4D4D"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.60652 13.5602C6.96451 13.9181 6.96451 14.4985 6.60652 14.8565C6.24854 15.2145 5.66814 15.2145 5.31016 14.8565L2.10183 11.6482C1.74385 11.2902 1.74385 10.7098 2.10183 10.3518L5.31016 7.14349C5.66814 6.7855 6.24854 6.7855 6.60652 7.14349C6.96451 7.50147 6.96451 8.08187 6.60652 8.43985L4.96304 10.0833H13.75C14.2563 10.0833 14.6667 10.4937 14.6667 11C14.6667 11.5063 14.2563 11.9167 13.75 11.9167L4.96304 11.9167L6.60652 13.5602Z" fill="#FE4D4D"></path>
                                                </svg>
                                                {{__('Logout')}}
                                                <form id="student-frm-logout" action="{{ route('student.logout',$store->slug) }}" method="POST" class="d-none">
                                                    {{ csrf_field() }}
                        ...
                        <a href="javascript:void(0)">
                            <span class="icon">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5 20C16.9183 20 20.5 16.4183 20.5 12C20.5 7.58172 16.9183 4 12.5 4C8.08172 4 4.5 7.58172 4.5 12C4.5 16.4183 8.08172 20 12.5 20ZM12.5 22C18.0228 22 22.5 17.5228 22.5 12C22.5 6.47715 18.0228 2 12.5 2C6.97715 2 2.5 6.47715 2.5 12C2.5 17.5228 6.97715 22 12.5 22Z" fill="url(#paint0_linear)"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.2467 18.1766C14.9854 16.6992 15.5 14.5183 15.5 12C15.5 9.48174 14.9854 7.30077 14.2467 5.82336C13.4482 4.22632 12.7151 4 12.5 4C12.2849 4 11.5518 4.22632 10.7533 5.82336C10.0146 7.30077 9.5 9.48174 9.5 12C9.5 14.5183 10.0146 16.6992 10.7533 18.1766C11.5518 19.7737 12.2849 20 12.5 20C12.7151 20 13.4482 19.7737 14.2467 18.1766ZM12.5 22C15.2614 22 17.5 17.5228 17.5 12C17.5 6.47715 15.2614 2 12.5 2C9.73858 2 7.5 6.47715 7.5 12C7.5 17.5228 9.73858 22 12.5 22Z" fill="url(#paint1_linear)" fill-opacity="0.5"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M22.4506 13C22.4833 12.6711 22.5 12.3375 22.5 12C22.5 11.6625 22.4833 11.3289 22.4506 11H2.54938C2.51672 11.3289 2.5 11.6625 2.5 12C2.5 12.3375 2.51672 12.6711 2.54938 13H22.4506Z" fill="url(#paint2_linear)" fill-opacity="0.5"></path>
                                    <defs>
                                        <linearGradient id="paint0_linear" x1="3.40361" y1="4.82609" x2="22.9041" y2="5.91723" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="var(--primary-color)"></stop>
                                            <stop offset="1" stop-color="var(--primary-color)"></stop>
                                        </linearGradient>
                                        <linearGradient id="paint1_linear" x1="7.95181" y1="4.82609" x2="17.7249" y2="5.09951" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="var(--primary-color)"></stop>
                                            <stop offset="1" stop-color="var(--primary-color)"></stop>
                                        </linearGradient>
                                        <linearGradient id="paint2_linear" x1="3.40361" y1="11.2826" x2="18.3009" y2="19.6183" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="var(--primary-color)"></stop>
                                            <stop offset="1" stop-color="var(--primary-color)"></stop>
                                        </linearGradient>
                                    </defs>
