...
<!-- Favicon -->
    ...
    @if(!empty($store->store_theme))
        <link rel="stylesheet" href="{{asset('Modules/LMS/Resources/assets/themes/theme4/css/'.$store->store_theme)}}" id="stylesheet">
    @else
        <link rel="stylesheet" href="{{asset('Modules/LMS/Resources/assets/themes/theme4/css/green-blue-style.css')}}" id="stylesheet">
    @endif
    <link rel="stylesheet" href="{{ asset('Modules/LMS/Resources/assets/themes/theme4/css/responsive.css') }}">
