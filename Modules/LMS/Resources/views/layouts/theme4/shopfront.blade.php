...
<html lang="en" dir="{{env('SITE_RTL') == 'on'?'rtl':''}}">
    @include('lms::layouts.theme4.shophead')
    <body>
        @include('lms::layouts.theme4.shopheader')
        ...
        <script src="{{ asset('Modules/LMS/Resources/assets/js/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
            ...
            <script src="{{ asset('Modules/LMS/Resources/assets/themes/theme4/js/custom.js') }}"></script>
