...
@php
    $path = url("/Modules/LMS/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('LMS  is The finest course builder. Right from managing the courses of various categories to fulfilling chapters, each aspect of your courses could be settled through LMS under one tab. Enjoy manageable learning with an easy user interface.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('LEARNING ')}}<b>{{__('MANAGEMENT ')}}</b>{{__('SYSTEM')}}</h2>
                <p>{{__('LMS is a one-stop solution for effective learning management.')}}</p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <div class="section-title">
                                <h2>{{__('Teach your students better, and get quicker results.')}}</h2>
                            </div>
                            <p>{{__('LMS is the ideal learners’ paradise. Expose your students to an immersive learning experience. Group your learners into groups, and deliver tailored content to them without stress.')}}</p>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Your Courses With Ease')}}</span>
                                </a>
                            ...
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Get Valuable Insights In A Matter Of Seconds')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Monitor and analyze data from each course and easily improve them. Get information about students’ progress, time logs, assessment data, and more. Know what learners are most enthusiastic about and generate tailored initiatives from one single tab.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Monitor Learning Progress')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Access detailed reports about how your learners are faring. Determine what areas they are struggling with and make suggestions easily. Get regular, up-to-date reports and many more in one easily accessible tab!')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Course Certificate Module to generate a certificate')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Course Certificate Management')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Easily generate certificates for completed courses in 4 easy steps. Just provide your store name, student name, course time, and course name. Choose from two templates and adjust the colors.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                            ...
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Management of Email subscribers list')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Get a list of interested students or customers and easily manage them. ')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Easy to manage learning by listing courses and courses’ categories')}}</h2>
                        </div>
                        <p>{{__('Easily organize all your courses by dividing them into distinct course categories. Easily manage all the courses in your store. Keep your inventories in a single tab and manage every aspect of your courses. View course details like names, prices, categories, qualities etc.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Create A Personalized Teaching And Learning Process')}}</h2>
                        </div>
                        <p>{{__('Update courses and add new study materials when needed. Adjust course difficulty and make the courses flow smoother. Easily edit lecture presentations and many more. Make the learning experience personal by exposing your clients to a process they won’t find anywhere else. Use LMSGo’s multilingual interface to create courses in your native tongue, and get them translated to each students’ favorite language.')}}</p>
                    </div>
                </div>
            </div>
        </div>
