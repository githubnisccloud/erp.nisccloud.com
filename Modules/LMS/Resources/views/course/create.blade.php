...
@section('page-action')
    <div>
        ...
        <input type="button" value="{{ __('Create') }}" class="btn btn-primary btn-submit" id="submit-all">
    </div>
@endsection
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control summernote {{ !empty($errors->first('course_requirements')) ? 'is-invalid' : '' }}" required name="course_requirements" id="exampleFormControlTextarea1" rows="3" ></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-6" id="course-content-3">
                                        ...
                                        <div id="subcategory-div">
                                            <select class="form-control choices" name="subcategory[]" id="subcategory" placeholder="{{__('Select Subcategory')}}"  multiple>
                                    ...
                                    <div class="col-md-6 d-none" id="discount-div">
                                        <div class="form-group ml-auto" id="discount">
