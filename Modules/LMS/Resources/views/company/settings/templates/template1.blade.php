...
<head>
    ...
    <style>
        ...
        .certificate_1_bg {
            ...
            background-image: url(asset(Modules/LMS/Resources/assets/certificate/img/bg-1.jpg));
            padding: 10px 10px;
...
<body>
                            ...
                            <div class="certificate_border">
                                ...
                                <div class="certificate_footer">
                                    <div class="certificate_logo">
                                        <img src="{{asset('Modules/LMS/Resources/assets/certificate/img/logo.png')}}" alt="logo">
                                    </div>
    ...
    @if(!isset($preview))
        <script src="{{ asset('Modules/LMS/Resources/assets/js/jquery-1.11.1.min.js') }} "></script>
