            ...
            buttons: [
                {
                    ...
                    class: 'firemodal_btn btn-primary btn btn-icon',
                    handler: function () {
                ...
                },
                {
                    ...
                    class: 'firemodal_btn btn-danger btn btn-icon ',
...
if ($('.course-category-slider').length > 0) {
    $('.course-category-slider').slick({
        arrows: true,
        dots: false,
        infinite: true,
        speed: 800,
...
if ($('.course-degree-slider').length > 0) {
    $('.course-degree-slider').slick({
        arrows: true,
        dots: false,
        infinite: true,
        speed: 1000,
...
if ($('.tutor-course-slider').length > 0) {
    $('.tutor-course-slider').slick({
        arrows: false,
        dots: true,
        infinite: true,
        speed: 1000,
...
if ($('.recent-views-slider').length > 0) {
    $('.recent-views-slider').slick({
        arrows: true,
        dots: false,
        infinite: true,
        speed: 1000,
...
if ($('.trending-courses-slider').length > 0) {
    $('.trending-courses-slider').slick({
        arrows: true,
        dots: false,
        infinite: true,
        speed: 1000,
...
if ($('.tutor-more-slider').length > 0) {
    $('.tutor-more-slider').slick({
        arrows: true,
        dots: false,
        infinite: true,
        speed: 1000,
...
$('.read-more').click(function() {
        ...
        if (($(this).text()) == "Read More") {
            $(this).text("Read Less").addClass("arrow_up");
        } else {
            $(this).text("Read More").removeClass("arrow_up");
        }
    });
...
$(function(){
    $(window).bind("resize",function(){
     if($(this).width() <992){
        $('div').removeClass('feature-product-card-big')
    }
    else{
         $('.feature-course-main .col-lg-6.col-md-6.col-12').addClass('feature-product-card-big')
     }
    }).resize();
 });
