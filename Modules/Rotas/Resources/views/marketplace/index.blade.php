...
@php
    $path = url("/Modules/Rotas/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Managing employees, their availability, shifts, leaves, and rates could become quite overwhelming, especially when you have multiple locations to cater to. Well no more.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Easily Manage Work Shifts…
                    With A')}}<b>{{__('Simple')}}</b>{{__(',Efficient, And')}} <b>{{__('Affordable')}}</b>{{__('Tool')}}</h2>
                <p>{{__('Manage your employees and their work shifts, availability, leaves, rates, and more - from anywhere, with one simple tool.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Organize Employees And Maximize Productivity')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Mobile Scheduling')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Schedule your employees’ shifts and assign tasks at any time. Easily manage availability preferences, view the details of all your employees, generate reports, and improve productivity - all inside one tool.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Flexible Management')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Easily edit every aspect of your business. Add or remove employees, days off, leaves, and more from the scheduled shifts. Set up face-to-face meetings at any time and easily reassign tasks to new employees. ')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Stay On Top Of Everything')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Let nothing escape you by receiving notifications of every important activity. Grant or reject employee leave requests, edit availability patterns, and manage every aspect of your business from a single tab.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('A Smart And Reliable Way To Schedule Shifts')}}</h2>
                        </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Easy Payment Management')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Safeguard your clients’ payment by using Stripe, PayPal, Flutterwave, and many more. Get paid for work done with a stress-free and secure payment process. Integrate up to 10 unique payment gateways.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Employee Details')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Manage every single information about your employees with ease. Get minute details like employment type, allowance, personal details and more in a single secure database. Also assign custom wages and salaries from a single tab.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Manage Multiple Locations')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Effectively manage several locations at a time. Assign employees to specific locations and manage their schedules. Easily switch locations and access a wide range of scheduling features - all under one roof.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('EMPLOYEE DATABANK')}}</h2>
                        </div>
                        <p>{{__('Manage every minute detail of an employee through this tab. From personal details to employee details, manage each aspect of basic information here. Employee details include employment type, holiday allowance based on days and hours, weekly hours, and working duration. Additionally, you can assign the roles and locations of that particular employee from here.
                            Further, assign the wages and salary of any particular employee by setting their default and role-wise custom rates. Lastly, determine their working and off days through this tab.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Comprehensive Dashboard')}}</h2>
                        </div>
                        <p>{{__('The dashboard would offer a monthly calendar view with general details about assigned users and costs incurred on any given day at a specific location. You can filter the details by selecting specific roles or all, based on your needs.')}}</p>
                    </div>
                </div>
            </div>
        </div>
