...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download Sample Rota Employee CSV File'), ['class' => 'col-form-label text-danger mx-1']) }}
...
<div class="modal-footer">
    ...
    <a href="" data-url="{{ route('rotaemployee.import.modal') }}" data-ajax-popup-over="true" title="{{ __('Create') }}" data-size="xl" data-title="{{ __('Import Rota Employee CSV Data') }}"  class="d-none import_modal_show"></a>
</div>
{{ Form::close() }}
