...
@section('page-action')
    <div class="float-end">
        <a href="{{ route('googlemeet.index') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
            title="{{ __('List View') }}" data-original-title="{{ __('List View') }}">
            <i class="ti ti-list"></i>
        </a>
        @permission('googlemeet create')
            <a href="#" data-size="lg" data-url="{{ route('googlemeet.create') }}" data-ajax-popup="true"
...
@push('css')
    <link rel="stylesheet" href="{{ asset('Modules/GoogleMeet/Resources/assets/css/main.css') }}">
@endpush
...
@push('scripts')
<script src="{{ asset('Modules/GoogleMeet/Resources/assets/js/main.min.js') }}"></script>
