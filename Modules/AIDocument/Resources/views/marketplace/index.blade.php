    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('AI WRITING ASSISTANT ')}}<b>{{__('AND')}}</b>{{__(' CONTENT GENERATOR TOOL')}}</h2>
                <p>{{__('AI Document can quickly produce high-quality content, saving significant time compared to manual writing processes.')}}</p>
            </div>
                        ...
                        <div class="theme-acnav">
                            <div class="set has-children">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('With AI Document ability to generate content at scale, businesses can produce a large volume of articles, blog posts, social media content, and more, increasing productivity and content output..')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('AI Document eliminates the need to hire or outsource content writers, reducing costs associated with content creation.')}}</p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                ...
                                <div class="acnav-list">
                                    <p>{{__('AI Document ensures consistency in tone, style, and brand voice throughout the generated content, maintaining a cohesive brand image.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        ...
                        <p>{{__('AI Document can create content in multiple languages, facilitating global reach and localization efforts.AI Document can detect and avoid plagiarism, generating original and unique content that meets ethical standards')}}</p>
                    </div>
                </div>
            </div>
        </div>
