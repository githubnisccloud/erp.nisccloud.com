                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12">
                        <div class="card card-body mb-2 p-3" >
                            <div class="row gy-3 mb-3 align-items-center">
                                ...
                                <div class="col-lg-4 mt-0 col-md-12 col-sm-12 text-md-end">
                                    @if(\Auth::user()->isAbleTo('ai document save'))
                                    <a href="#" class="btn btn-sm  btn-primary" data-bs-toggle="tooltip" data-bs-original-title="{{__('Save Document')}}" onclick="save_doc(<?=$document->id?>)"><i data-feather="save"></i></a>
                                    @else
                                    <a href="#" class="btn btn-sm  btn-primary" data-bs-toggle="tooltip" data-bs-original-title="{{__('Save Document')}}" onclick="preventAccess();"><i data-feather="save"></i></a>
                                    @endif
                                    @if(\Auth::user()->isAbleTo('ai document generate Word'))
                                    <a href="#" class="btn btn-sm  btn-info" data-bs-toggle="tooltip" data-bs-original-title="{{__('All Response Export as Word Document')}}" onclick="exportWordDocallresponse(<?=$document->id?>)"><i class="ti ti-file-download"></i></a>
                                    @else
                                    <a href="#" class="btn btn-sm  btn-info" data-bs-toggle="tooltip" data-bs-original-title="{{__('All Response Export as Word Document')}}" onclick="preventAccess()"><i class="ti ti-file-download"></i></a>
                                    @endif
                                    @if(\Auth::user()->isAbleTo('ai document copy'))
                                    <a href="#" class="btn btn-sm  btn-warning" data-bs-toggle="tooltip" data-bs-original-title="{{__('Copy All Response')}}" onclick="copyallresponse(<?=$document->id?>)"><i class="ti ti-copy"></i></a>
                                    @else
                                    <a href="#" class="btn btn-sm  btn-warning" data-bs-toggle="tooltip" data-bs-original-title="{{__('Copy All Response')}}" onclick="preventAccess()"><i class="ti ti-copy"></i></a>
                                    @endif
                                </div>
                            </div>
                        </div>
