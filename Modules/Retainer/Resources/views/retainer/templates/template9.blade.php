    ...
    <div class="invoice-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
            ...
            <table class="vertical-align-top">
                <tbody>
                    <tr>
                        ...
                        <td class="text-right"><img class="invoice-logo" src="{{ $img }}" alt=""></td>
                ...
                <table class="no-space vertical-align-top">
                    <tbody>
                        <tr>
                            <td>{{ __('Number: ') }}</td>
                            <td class="text-right">
                                {{ \App\Models\Invoice::invoiceNumberFormat($retainer->retainer_id, $retainer->created_by, $retainer->workspace) }}
                            </td>
                        </tr>
                        <tr>
                            <td>{{ __('Issue Date:') }}</td>
        ...
        <div class="invoice-body" style="padding-right: 0;">
            ...
            <div class="invoice-footer">
                <p> {{ $settings['retainer_footer_notes'] }}</p>
                <h6>{{ $settings['retainer_footer_title'] }}</h6>
            </div>
        </div>
    </div>
    @if (!isset($preview))
