...
@push('scripts')
    ...
    @if (module_is_active('Taskly'))
        <script>
            ...
            $(document).on('keyup change', '#tax_project', function() {
                var tax_id = $(this).val();
                if (tax_id.length != 0) {
                    $.ajax({
                        type: 'post',
...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'retainer', 'class' => 'w-100', 'enctype'=>'multipart/form-data']) }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers, $customerId, ['class' => 'form-control', 'id' => 'customer', 'data-url' => route('retainer.customer'), 'required' => 'required', 'placeholder' => 'Please Select']) }}
                                            ...
                                            <div class="d-flex radio-check">
                                                <div class="form-check form-check-inline form-group col-md-3">
                                                    <input type="radio" id="product" value="product"
                                                        name="retainer_type_radio" class="form-check-input code"
                                                        checked="checked">
