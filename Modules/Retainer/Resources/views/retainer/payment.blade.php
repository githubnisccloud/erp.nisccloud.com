{{ Form::open(array('route' => array('retainer.payment', $retainer->id),'method'=>'post','enctype' => 'multipart/form-data')) }}
...
<div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('amount',$retainer->getDue(), array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
        </div>
