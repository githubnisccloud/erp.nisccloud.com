...
@php
    $path = url("/Modules/Retainer/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Retainer invoices are documents the firm can provide to the client to ask for funds prior to the project starting. Its a method of securing services for use when required. In other words, its a form of deposit or pre-payment.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('It’s a form of')}}<b>{{__(' deposit')}}</b>{{__(' or pre-payment')}}</h2>
                <p>{{__('Retainer invoices are documents the firm can provide to the client to ask for funds prior to the project starting. It’s a method of securing services for use when required. In other words, it’s a form of deposit or pre-payment.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('What is a Retainer Invoice?')}}</h2>
                        </div>
                        <p>{{__('When you collect advance payments from your clients, they can’t be considered immediate income. ')}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Retainer in accounting')}}</h2>
                        </div>
                        <p>{{__('The term “retainer” in accounting means the
                        client pays a part or all of the services as an advance.
                        If, in case, the retainer is “pay for access,” it means the business or service provider must provide services to the client regularly for a set number of hours every month. Also, the retainer payment must be paid immediately after the agreement is signed.')}}</p>
                    </div>
                </div>
            </div>
        </div>
